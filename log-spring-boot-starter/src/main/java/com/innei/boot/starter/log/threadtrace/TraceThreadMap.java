package com.innei.boot.starter.log.threadtrace;
...
/**
 * Created by LIUMI969 on 2017/5/5.
 */
public class TraceThreadMap implements ThreadContextMap {
    private final ThreadLocal<Map<String, String>> localMap;

    public TraceThreadMap() {
